...
- [Playground](https://thegraph.com/explorer/subgraph/dan13ram/fdai-token)
...
`
const QUERY_URL = `https://api.thegraph.com/subgraphs/name/dan13ram/fdai-token`
